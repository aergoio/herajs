 ...
 */
const verifyTxSignature = async (tx: any, key: ec.KeyPair, signature: string, enc: 'base64' | 'ascii' | 'utf8' | 'utf-8' | 'utf16le' | 'ucs2' | 'ucs-2' | 'latin1' | 'binary' | 'hex' = 'base64'): Promise<boolean> => {
