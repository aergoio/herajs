...
import { Amount, Address, AergoClient } from '@herajs/client';
import { hashTransaction, decryptPrivateKey, identifyFromPrivateKey, signTransaction, signMessage, encryptPrivateKey, decodePrivateKey, createIdentity } from '@herajs/crypto';
  ...
  _createClass(SignedTransaction, [{
    ...
    value: function () {
      var _getHash = _asyncToGenerator(function* () {
        ...
        var hash = yield hashTransaction(_objectSpread({}, this.txBody, {
  ...
  _createClass(Key, [{
    ...
    value: function () {
      var _signTransaction2 = _asyncToGenerator(function* (tx) {
        ...
        var signature = yield signTransaction(_objectSpread({}, tx.txBody), this.keyPair);
    ...
    get: function get() {
      if (!this._keyPair) {
        ...
        var identity = identifyFromPrivateKey(Uint8Array.from(this.data.privateKey));
  ...
  _createClass(KeyManager, [{
    ...
    value: function addKey(account, privateKey) {
      ...
      if (this.wallet.keystore) {
        ...
        var privateKeyEncrypted = encryptPrivateKey(Uint8Array.from(privateKey), this.masterPassphrase);
    ...
    value: function () {
      var _importKey = _asyncToGenerator(function* (importSpec) {
        ...
        if (typeof importSpec.b58encrypted === 'string' && typeof importSpec.password === 'string') {
          var encryptedKey = decodePrivateKey(importSpec.b58encrypted);
          rawKey = yield decryptPrivateKey(encryptedKey, importSpec.password);
        }
    ...
    */
    ...
    value: function () {
      var _unlock = _asyncToGenerator(function* (passphrase) {
        ...
        try {
          yield decryptPrivateKey(Uint8Array.from(encryptedId.data.value), passphrase);
        } catch (e) {
    ...
    value: function () {
      var _setupAndUnlock = _asyncToGenerator(function* (appId, passphrase) {
        ...
        var encryptedId = new EncryptedIdSetting('encryptedId', {
          value: Array.from((yield encryptPrivateKey(Buffer.from(appId), passphrase)))
        });
  ...
  _createClass(Wallet, [{
    ...
    value: function getClient(chainId) {
      ...
      if (!this.clients.has(chainId)) {
        ...
        var client = new AergoClient({}, _provider);
        ...
        return (
          ...
          function () {
            var _ref2 = _asyncToGenerator(function* (_ref) {
              ...
              var client = wallet.getClient(accountSpec.chainId);
              var address = new Address(accountSpec.address);

              var _ref3 = yield client.getState(address),
                  nonce = _ref3.nonce,
              ...
              while (blockNumber > limit && (nonce > 1 || balance.compare(0) > 0)) {
                var block = yield client.getBlock(blockNumber--);
        ...
        return (
          ...
          function () {
            var _ref5 = _asyncToGenerator(function* (_ref4) {
              ...
              if (!limit) {
                var _ref6 = yield client.blockchain(),
              ...
              var _ref7 = yield client.getState(address),
                  nonce = _ref7.nonce,
  ...
  _createClass(IndexedDbStorage, [{
    ...
    value: function () {
      var _open = _asyncToGenerator(function* () {
        ...
        this.db = yield openDB(this.name, this.version, {
          upgrade: upgrade
        });
        return this;
      });
...
export { Account, IndexedDbStorage, Key, MemoryStorage, NodeTransactionScanner, Transaction, Wallet };
