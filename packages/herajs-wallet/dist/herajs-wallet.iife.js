(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@elderapo/typed-event-emitter'), require('@herajs/client'), require('@herajs/crypto'), require('idb')) :
  typeof define === 'function' && define.amd ? define(['exports', '@elderapo/typed-event-emitter', '@herajs/client', '@herajs/crypto', 'idb'], factory) :
  (global = global || self, factory(global.HerajsWallet = {}, global['@elderapo/typed-event-emitter'], global['@herajs/client'], global['@herajs/crypto'], global.idb));
}(this, function (exports, typedEventEmitter, client, crypto, idb) { 'use strict';
