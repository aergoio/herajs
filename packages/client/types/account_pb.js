...
goog.exportSymbol("types.Account", null, proto);
goog.exportSymbol("types.AccountList", null, proto);
/**
...
proto.types.AccountList = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.types.AccountList.repeatedFields_,
    null
  );
};
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.types.Account.deserializeBinaryFromReader
        );
 ...
 * @return {!proto.types.AccountList} returns this
 */
 ...
 * @return {!proto.types.Account}
 */
proto.types.AccountList.prototype.addAccounts = function (
  opt_value,
  opt_index
) {
