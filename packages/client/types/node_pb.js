...
goog.exportSymbol("types.AgentCertificate", null, proto);
goog.exportSymbol("types.PeerAddress", null, proto);
goog.exportSymbol("types.PeerRole", null, proto);
/**
...
proto.types.PeerAddress = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.types.PeerAddress.repeatedFields_,
    null
  );
};
...
proto.types.AgentCertificate = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.types.AgentCertificate.repeatedFields_,
    null
  );
};
...
/**
 * @param {string} value
 * @return {!proto.types.PeerAddress} returns this
 */
...
proto.types.PeerAddress.prototype.getProduceridsList_asB64 = function () {
  return /** @type {!Array<string>} */ (
    jspb.Message.bytesListAsB64(this.getProduceridsList())
  );
};
...
proto.types.PeerAddress.prototype.getProduceridsList_asU8 = function () {
  return /** @type {!Array<!Uint8Array>} */ (
    jspb.Message.bytesListAsU8(this.getProduceridsList())
  );
};
...
proto.types.PeerAddress.prototype.clearProduceridsList = function () {
  return this.setProduceridsList([]);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.types.AgentCertificate.prototype.toObject = function (
    opt_includeInstance
  ) {
 ...
 * @return {!proto.types.AgentCertificate}
 */
proto.types.AgentCertificate.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.types.AgentCertificate.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
/**
 * @param {number} value
 * @return {!proto.types.AgentCertificate} returns this
 */
...
proto.types.AgentCertificate.prototype.getBpid_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getBpid()));
};
...
proto.types.AgentCertificate.prototype.getBpid_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getBpid()));
};
...
proto.types.AgentCertificate.prototype.getBppubkey_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getBppubkey()));
};
...
proto.types.AgentCertificate.prototype.getBppubkey_asU8 = function () {
  return /** @type {!Uint8Array} */ (
    jspb.Message.bytesAsU8(this.getBppubkey())
  );
};
...
proto.types.AgentCertificate.prototype.getAgentid_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getAgentid()));
};
...
proto.types.AgentCertificate.prototype.getAgentid_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getAgentid()));
};
...
proto.types.AgentCertificate.prototype.getAgentaddressList_asB64 = function () {
  return /** @type {!Array<string>} */ (
    jspb.Message.bytesListAsB64(this.getAgentaddressList())
  );
};
...
proto.types.AgentCertificate.prototype.getAgentaddressList_asU8 = function () {
  return /** @type {!Array<!Uint8Array>} */ (
    jspb.Message.bytesListAsU8(this.getAgentaddressList())
  );
};
 ...
 * @return {!proto.types.AgentCertificate} returns this
 */
proto.types.AgentCertificate.prototype.addAgentaddress = function (
  value,
  opt_index
) {
  return jspb.Message.addToRepeatedField(this, 7, value, opt_index);
...
proto.types.AgentCertificate.prototype.clearAgentaddressList = function () {
  return this.setAgentaddressList([]);
};
